      ...
      <Form.Root action={dispatch}>
        ...
        <Form.Footer error={state?.message}>
          ...
          <div className="text-sm text-neutral-500 font-semibold text-center lg:text-sm xs:text-xs xs:mt-1">
            Não tem conta? Acesse a página de <Link className="text-emerald-primary underline underline-offset-2 hover:text-emerald-third" href="/cadastro">Cadastro</Link>
          </div>
        </Form.Footer>
      </Form.Root>
    </main>
